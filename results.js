document.addEventListener("DOMContentLoaded", () => {
  ...
  if (statusText === "PASSED") {
    ...
    document.querySelector("#congratulations-message").textContent =
    ...
    document.querySelector("#congratulations-message").textContent =
      "Sorry, you have failed the test. Better luck next time.";
